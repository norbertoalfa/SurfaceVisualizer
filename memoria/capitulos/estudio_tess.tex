...
\section{Tessellation shader}
	...
	Hablar de la primera aproximación, el volumen entre la superficie y el triángulo (en los lados es el área).
	Hablar de la segunda aproximación, el área a aproximar de la superficie y la del triángulo (en los lados es la longitud de la curva).
