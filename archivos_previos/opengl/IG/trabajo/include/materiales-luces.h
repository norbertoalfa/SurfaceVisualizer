...
{
   public: TexturaXY( const std::string & nom ): Textura(nom) {modo_gen_ct   = mgct_coords_objeto ;}
} ;
class TexturaXZ : public Textura
{
   public: TexturaXZ( const std::string & nom ): Textura(nom) {modo_gen_ct   = mgct_coords_ojo ;}
} ;
// *********************************************************************
// Clase Material
// ---------------------------------------------------------------------
...
class FuenteLuz
{
   ...
   // para fuentes diraccionales, incrementar o decrementar la latitud
   // (en las puntuales no hace nada)
