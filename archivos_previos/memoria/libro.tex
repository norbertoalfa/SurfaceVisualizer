...
\usepackage[english, spanish, es-nodecimaldot, es-noindentfirst, es-tabla, es-lcroman]{babel}
...
}\part{Teorema clásico de Munkres}

\input{capitulos/conceptos_previos}
\input{capitulos/cap_res_previos}
\input{capitulos/teoremas}
...
\input{capitulos/conceptos_visualizacion}
\input{capitulos/estudio_tess}
\input{capitulos/procesador}

\input{capitulos/planificacion_presupuesto}
\input{capitulos/analisis_diseño}
\input{capitulos/implementacion_pruebas}

\pdfbookmark[-1]{Conclusiones}{appendix}
\input{preliminares/conclusiones}
...
\input{apendices/guia_instalacion}
\input{apendices/guia_uso}
...
\nocite{*}
\setbibpreamble{A continuación se lsitan todas las referencias por orden alfabético. Aquellas referencias con más de un autor están ordenadas de acuerdo con el primer autor.\par\bigskip}
