...
vec3 h(float u, float v, float t0, float t1) {
	return vec3( f(10 * (u - 0.5), 10 * (v - 0.5), t0, t1));
}
...
vec3 hPu(float u, float v, float t0, float t1) {
	return vec3(( fPu(10 * (u - 0.5), 10 * (v - 0.5), t0, t1) * 10));
}

vec3 hPv(float u, float v, float t0, float t1) {
	return vec3(( fPv(10 * (u - 0.5), 10 * (v - 0.5), t0, t1) * 10));
}
...
vec3 hPuPu(float u, float v, float t0, float t1) {
	return vec3((( fPuPu(10 * (u - 0.5), 10 * (v - 0.5), t0, t1) * 10) * 10));
}
...
vec3 hPvPv(float u, float v, float t0, float t1) {
	return vec3((( fPvPv(10 * (u - 0.5), 10 * (v - 0.5), t0, t1) * 10) * 10));
}

vec3 hPuPv(float u, float v, float t0, float t1) {
	return vec3((( fPuPv(10 * (u - 0.5), 10 * (v - 0.5), t0, t1) * 10) * 10));
}
